...
export default function Hero() {
  return (
    <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-20 lg:pt-40 lg:pb-32 px-5 sm:px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-10 lg:gap-8 min-h-[90vh] bg-white overflow-hidden">
      ...
      {/* FIX: Mengganti flex-1 menjadi w-full lg:w-1/2 lg:flex-1 agar tidak collapse di mobile */}
      <div className="w-full lg:w-1/2 lg:flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10 max-w-2xl mx-auto lg:mx-0">
        ...
        {/* Headline Raksasa (Responsive Text Size) */}
        <h1 
          className="text-4xl sm:text-5xl md:text-6xl lg:text-[4.5rem] xl:text-7xl font-extrabold tracking-tighter text-slate-900 leading-[1.1] sm:leading-[1.05] mb-4 sm:mb-6"
        ...
        {/* CTA Buttons (Responsive Stacking & Spacing) */}
      ...
      {/* ── KANAN: OVERLAPPING MOCKUPS (RESPONSIVE SCALING) ── */}
      {/* FIX: Margin top diperbesar di mobile (mt-12) dan menggunakan w-full lg:flex-1 */}
      <div className="w-full lg:w-1/2 lg:flex-1 relative z-10 h-[380px] sm:h-[450px] lg:h-[500px] xl:h-[600px] mt-12 lg:mt-0 flex justify-center lg:justify-end">
        ...
        {/* FIX: INNER WRAPPER - Menjaga agar kedua mockup tetap menyatu (tidak terpisah ke ujung layar) pada Tablet/Mobile */}
        <div className="relative w-full max-w-[420px] sm:max-w-[500px] lg:max-w-none h-full">

          {/* 1. DESKTOP MOCKUP (Di Belakang) - Skala Responsive */}
          <div className="absolute top-0 right-0 w-[85%] sm:w-[85%] h-[280px] sm:h-[360px] lg:h-[400px] xl:h-[480px] bg-white border border-slate-200/80 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)] rounded-xl sm:rounded-2xl overflow-hidden flex flex-col font-sans">
            ...
            <div className="flex flex-1 overflow-hidden bg-slate-50/50">
              {/* Sidebar Mini (Responsive Width) */}
              <div className="w-12 sm:w-16 lg:w-40 xl:w-48 bg-white border-r border-slate-100 p-2 sm:p-3 lg:p-4 flex flex-col gap-3 sm:gap-4 shrink-0 items-center lg:items-stretch">
              ...
              {/* Main Area Desktop */}
              <div className="flex-1 p-3 sm:p-4 lg:p-6 flex flex-col gap-3 sm:gap-4 overflow-hidden">
                ...
                <div className="flex-1 bg-white border border-slate-100 shadow-sm p-2 sm:p-3 rounded-lg sm:rounded-xl overflow-hidden flex flex-col">
                  ...
                  <div className="space-y-1.5 sm:space-y-3 overflow-hidden">
                    ...
                    {/* Item ke-3 disembunyikan di HP sangat kecil agar tidak keluar container */}
                    <div className="hidden sm:flex items-center justify-between">
                      <div className="flex items-center gap-3 overflow-hidden">
                        <div className="size-8 rounded bg-slate-100 border border-slate-200 overflow-hidden shrink-0">
                          <img src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=100&h=100&fit=crop&q=80" alt="img" className="w-full h-full object-cover" />
                        </div>
                        <div className="overflow-hidden pr-1">
                          <div className="text-xs font-bold text-slate-900 truncate">Tanam Pohon</div>
                          <div className="text-[9px] text-slate-500 truncate">Bandung, ID</div>
                        </div>
                      </div>
                      <div className="flex items-center gap-1 text-[9px] font-bold text-red-700 bg-red-50 px-2 py-1 rounded shrink-0">
          ...
          <div className="absolute bottom-0 lg:bottom-4 left-0 sm:left-4 lg:-left-4 w-[140px] sm:w-[180px] lg:w-[220px] xl:w-[240px] h-[280px] sm:h-[360px] lg:h-[440px] xl:h-[480px] bg-white border-[4px] sm:border-[6px] lg:border-[8px] border-slate-900 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.3)] rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[3rem] overflow-hidden flex flex-col z-20 font-sans">
            ...
            <div className="flex-1 overflow-hidden bg-slate-50/50 flex flex-col p-2.5 sm:p-3 lg:p-4">
              ...
              <div className="space-y-1.5 sm:space-y-1.5 lg:space-y-2 flex-1 overflow-hidden">
                ...
                <div className="bg-white border border-slate-100 shadow-sm p-1.5 sm:p-1.5 lg:p-2 rounded-md sm:rounded-lg flex items-center gap-1.5 sm:gap-1.5 lg:gap-2">
                  <div className="size-5 sm:size-6 lg:size-8 rounded bg-sky-50 flex items-center justify-center shrink-0">
                    <Recycle className="size-2.5 sm:size-3 lg:size-4 text-sky-600" />
                  </div>
                  <div className="flex-1 overflow-hidden">
                    <div className="text-[7px] sm:text-[9px] lg:text-[10px] font-bold text-slate-900 truncate">Daur Ulang</div>
                    <div className="text-[5px] sm:text-[7px] lg:text-[8px] text-slate-500 truncate">May 19, 2026</div>
                  </div>
                  <div className="text-[6px] sm:text-[8px] lg:text-[9px] font-bold text-emerald-600 shrink-0">+81 pt</div>
                </div>
              </div>
            </div>

            {/* Bottom Nav Mobile */}
            <div className="h-10 sm:h-12 lg:h-16 bg-white border-t border-slate-100 flex items-center justify-around px-2 sm:px-3 lg:px-4 shrink-0 pb-0.5 sm:pb-1">
