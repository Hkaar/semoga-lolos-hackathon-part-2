...
const steps = [
  {
    ...
    description:
      "Citizens simply snap a photo of their environmental action and send it to our Telegram Bot. No complicated apps, forms, or manual paperwork required.",
    icon: Smartphone,
    color: "text-blue-600",
    bg: "bg-blue-100/50",
  ...
  },
  {
    ...
    description:
      "Our advanced AI instantly analyzes the photo's visual data, GPS location, and timestamp to ensure the action is genuine and securely calculate its impact score.",
    icon: Bot,
  ...
  },
  {
    ...
    description:
      "Once verified by AI, the action is permanently recorded on the blockchain. This creates a transparent, tamper-proof digital receipt that cannot be altered or faked.",
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description:
      "CSR teams can monitor these fully verified actions in real-time through the dashboard and release funding automatically with complete transparency and confidence.",
    icon: BarChart3,
  ...
  return (
    ...
    >
      <div className="flex flex-row items-start gap-4 sm:gap-5">
        ...
        >
          <step.icon
            className={cn("size-6 sm:size-7", step.color)}
            strokeWidth={2}
          />
        </div>
...
export default function HowItWorks() {
  ...
  const [activeSteps, setActiveSteps] = useState<
    Array<(typeof steps)[0] & { uid: number }>
  >([]);
  ...
  return (
    <section
      id="how-it-works"
      className="relative py-24 lg:py-32 px-5 sm:px-6 max-w-7xl mx-auto overflow-hidden"
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center lg:items-start lg:text-left z-10">
          ...
          <p
            ...
            style={{ fontFamily: '"Inter", sans-serif' }}
          >
            We fixed the broken system. No more manual reports, fraud risks, or
            delayed funds. Watch how real-time actions from the ground turn into
            verifiable impact in four automated steps.
          </p>

          <Button
            asChild
            className="h-14 px-8 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-base shadow-xl transition-all group  hover:-translate-y-1 hover:shadow-2xl hover:shadow-slate-900/20 w-full sm:w-auto"
          >
            <a href="/dashboard">
