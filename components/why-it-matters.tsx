...
const BeamNode = ({
  ...
  >
    <div
      className={cn(
        "rounded-2xl flex items-center justify-center shadow-sm relative group bg-white",
        size,
      )}
    >
      {/* Efek Ping/Glow di belakang icon */}
      <div
        className={`absolute inset-0 rounded-2xl opacity-20 ${bg} animate-ping`}
        style={{ animationDelay: delay, animationDuration: "3s" }}
      />
      {/* Container utama icon */}
      <div
        className={cn(
          "relative z-10 size-full rounded-2xl flex items-center justify-center bg-white border",
          border,
        )}
      >
    ...
    <div className="relative w-full max-w-5xl mx-auto aspect-square md:aspect-[2/1] bg-slate-50/50 rounded-[2.5rem] border border-slate-200/80 shadow-inner overflow-hidden mb-20 lg:mb-24 flex items-center justify-center">
      ...
      */}
      ...
      >
        ...
        >
          <path
            d="M 100 80 C 250 80, 250 200, 400 200"
            pathLength="100"
          ...
          />
          <path
            d="M 100 320 C 250 320, 250 200, 400 200"
            pathLength="100"
            className="animate-beam-3"
          />
          <path
            d="M 400 200 C 550 200, 550 120, 700 120"
            pathLength="100"
            className="animate-beam-1"
          />
          <path
            d="M 400 200 C 550 200, 550 280, 700 280"
            pathLength="100"
            className="animate-beam-2"
          />
        </g>
...
const benefits = [
  {
    ...
    description:
      "AI verification ensures every action submitted is genuine, transparent, and fully accountable. Say goodbye to fabricated data.",
    color: "text-emerald-600",
    bg: "bg-emerald-50/80",
  ...
  },
  {
    ...
    description:
      "No more waiting for end-of-month reports. Real-time verified data helps you act quickly and release funds to high-impact actions instantly.",
    color: "text-blue-600",
    bg: "bg-blue-50/80",
  ...
  },
  {
    ...
    description:
      "Track exactly what is happening on the ground and measure the direct environmental impact your funding creates, minute by minute.",
    color: "text-teal-600",
    bg: "bg-teal-50/80",
...
export default function WhyItMatters() {
  return (
    <section
      id="why-it-matters"
      className="relative pt-20 pb-24 lg:pt-32 lg:pb-32 px-5 sm:px-6 max-w-7xl mx-auto overflow-hidden bg-white"
    >
      ...
      <div className="flex flex-col items-center text-center mb-10 z-10 relative">
        ...
        <Badge
          variant="outline"
          className="px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-emerald-700 border-emerald-200 bg-emerald-50/80 backdrop-blur-sm shadow-sm mb-6 gap-2"
        >
        ...
        >
          By automating verification and removing human bottlenecks, we empower
          CSR teams to focus on what truly matters: scaling real, measurable
          impact.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-24 lg:mb-32 relative z-10">
        {benefits.map((benefit, index) => (
          ...
          >
            ...
            >
              <benefit.icon
                className={cn("size-6", benefit.color)}
                strokeWidth={2}
              />
            </div>
      ...
      <div className="relative w-full rounded-[3rem] bg-[#f8faf9] border border-slate-200/60 p-8 sm:p-12 lg:p-16 overflow-hidden flex flex-col lg:flex-row items-center gap-12 lg:gap-16 shadow-sm">
        ...
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
          <Badge
            variant="outline"
            className="text-xs font-bold text-emerald-700 uppercase tracking-widest mb-4 flex items-center gap-2 border-emerald-200 bg-emerald-50 px-2.5 py-1"
          >
          ...
          <p
            ...
            style={{ fontFamily: '"Inter", sans-serif' }}
          >
            Explore real actions from the field, verified by AI and ready for
            funding in a clean, intuitive dashboard.
          </p>
          <Button
            asChild
          ...
          <div className="w-full max-w-[500px] bg-white rounded-2xl border border-slate-200/80 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)] transform-gpu transition-transform duration-700 hover:scale-[1.02] hover:-translate-y-2 overflow-hidden flex flex-col">
            ...
            <div className="p-5 sm:p-6 bg-slate-50/30">
              <div className="flex justify-between items-end mb-4 border-b border-slate-100 pb-3">
                ...
                <div className="text-[10px] font-semibold text-emerald-600 cursor-pointer hover:underline">
                  View all
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center justify-between group/item bg-white p-3 rounded-xl border border-slate-100 shadow-sm transition-colors hover:border-emerald-100">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-12 sm:w-14 h-9 sm:h-10 rounded-lg bg-slate-100 overflow-hidden shrink-0 border border-slate-200/60">
                      <img
                        src="https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?w=100&h=70&fit=crop&q=80"
                        alt="Pilah Sampah"
                        className="w-full h-full object-cover"
                      />
                    </div>
                    <div className="overflow-hidden pr-2">
                      <div className="text-xs sm:text-sm font-bold text-slate-900 mb-0.5 truncate">
                        Pilah Sampah Plastik
                      </div>
                      <div className="text-[9px] sm:text-[10px] font-medium text-slate-500 truncate">
                        20 May 2026, 09:41 WIB
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center gap-4 sm:gap-6 shrink-0">
                    <Badge
                      variant="secondary"
                      className="hidden sm:flex items-center gap-1 text-[9px] font-bold text-emerald-700 bg-emerald-50 border border-emerald-100/50 px-2 py-0.5 shadow-none"
                    >
                    ...
                    <div className="text-right">
                      ...
                      <div className="text-[8px] font-medium text-slate-400 mt-1">
                        High Impact
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between group/item bg-white p-3 rounded-xl border border-slate-100 shadow-sm transition-colors hover:border-amber-100">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-12 sm:w-14 h-9 sm:h-10 rounded-lg bg-slate-100 overflow-hidden shrink-0 border border-slate-200/60">
                      <img
                        src="https://images.unsplash.com/photo-1618477461853-cf6ed80fbfc9?w=100&h=70&fit=crop&q=80"
                        alt="Bersih Pantai"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 shrink-0">
                    <Badge
                      variant="secondary"
                      className="hidden sm:flex items-center gap-1 text-[9px] font-bold text-amber-700 bg-amber-50 border border-amber-100/50 px-2 py-0.5 shadow-none"
                    >
                ...
                <div className="flex items-center justify-between group/item bg-white p-3 rounded-xl border border-slate-100 shadow-sm transition-colors hover:border-red-100">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="w-12 sm:w-14 h-9 sm:h-10 rounded-lg bg-slate-100 overflow-hidden shrink-0 border border-slate-200/60">
                      <img
                        src="https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=100&h=70&fit=crop&q=80"
                        alt="Tanam Pohon"
                        className="w-full h-full object-cover"
                      />
                    </div>
                  ...
                  <div className="flex items-center gap-4 sm:gap-6 shrink-0">
                    <Badge
                      variant="secondary"
                      className="hidden sm:flex items-center gap-1 text-[9px] font-bold text-red-700 bg-red-50 border border-red-100/50 px-2 py-0.5 shadow-none"
                    >
      ...
      <div className="mt-20 lg:mt-32 relative w-full rounded-[3rem] bg-emerald-50/50 border border-emerald-100 p-10 sm:p-16 lg:p-24 flex flex-col items-center text-center overflow-hidden shadow-sm">
        ...
        <Badge
          variant="outline"
          className="px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-emerald-700 border-emerald-200 bg-white shadow-sm mb-6 gap-2 relative z-10"
        >
          Get Started
        </Badge>
        ...
        <p
          ...
          style={{ fontFamily: '"Inter", sans-serif' }}
        >
          Join forward-thinking companies using Klimabot to create a cleaner,
          greener future based on verified data.
        </p>
